...
my $io =
    new SBG::DomainIO::stamp(file => $file, objtype => 'SBG::Domain::Atoms');
...
pdl_approx($dom2_2->coords->slice('0:2,0'),
    $first_ca_native, "Verifying coords of untransformed CA");
...
pdl_approx($dom2_0->coords->slice('0:2,0'),
    $first_ca_trans, "Verifying coords of transformed CA");
