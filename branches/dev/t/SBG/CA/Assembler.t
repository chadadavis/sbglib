...
ok($assembler->test($complex, $net, 'c1', 'c2', $interactions->[0]),
    'Add interaction');
ok($assembler->test($complex, $net, 'c2', 'c3', $interactions->[1]),
    'Add interaction');
ok($assembler->test($complex, $net, 'c3', 'c4', $interactions->[2]),
    'Add interaction');
ok($assembler->test($complex, $net, 'c4', 'c5', $interactions->[3]),
    'Add interaction');
ok($assembler->test($complex, $net, 'c5', 'c6', $interactions->[4]),
    'Add interaction');
