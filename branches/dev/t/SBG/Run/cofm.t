...
$input = SBG::Domain->new(
    pdbid      => '2frq',
    descriptor => 'B 100 _ to B 131 A B 150 _ to B 155 B'
);
...
$input = SBG::Domain->new(
    pdbid      => '1dan',
    descriptor => 'CHAIN T U 91 _ to U 106 _'
);
_test($input, 12.424, (33.875, 22.586, 43.569));

# Without a PDB ID;
$input = SBG::Domain->new(
    file       => "$Bin/../data/docking2.pdb",
    descriptor => 'CHAIN A'
);
...
$input = SBG::Domain->new(
    file       => "$Bin/../data/P29295.1-P41819.1-complex.2",
    descriptor => 'CHAIN A'
);
...
$input = SBG::Domain->new(
    file =>
        "$Bin/../data/loooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong.pdb",
    descriptor => 'CHAIN A'
);
_test($input, 19.636, (40.593, 9.387, 82.034));
